...
public class ContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new ContactsAdapter.OnContactClickListener() {
            @Override
            public void onContactClick(Contact contact, ActivityOptionsCompat options) {
                ...
                extras.putSerializable(DetailsActivity.EXTRA_CONTACT, contact);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id)
        {
            case R.id.action_add:
                final Contact contact = Contact.getRandomContact(getApplicationContext());
