...
struct Bound
{
	...
	void Draw()
	{
		...
		//mNumVertices=6;
		float x=0,y=0,z=0;
		verticesData[0].position=Vector3(topleft.x,topleft.y,0.0f);
		verticesData[1].position=Vector3(bottomleft.x,bottomleft.y,0.0f);
		verticesData[2].position= Vector3(bottomright.x,bottomright.y,0.0f);

		verticesData[3].position = Vector3(topleft.x,topleft.y,0.0f);
		verticesData[4].position = Vector3(bottomright.x,bottomright.y,0.0f);
		verticesData[5].position = Vector3(topright.x,topright.y,0.0f);
