...
{
    /// <summary>
    /// Summary description for EnViTranslationService
    /// </summary>
    ...
    public class EnViTranslationService : System.Web.Services.WebService
    {
        [WebMethod]
        public string Translate(string keyword)
        {
            ...
            Dictionary<string, string> dict = loadData("~/App_Data/en_vi.xml");
